...
import { formatBudgetRuleRunResults, runBudgetRules, type BudgetRuleRunResult } from "./runBudgetRules.js";
...
export const formatTopUpRunResults = formatBudgetRuleRunResults;
